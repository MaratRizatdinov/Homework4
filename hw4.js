...
alert (`Последнее число, полученное от деления = ${n}`);
//-------------------------------------------------------------------------------------------

//Задание 6

// В вашей компании пятница является днем отчетным.Нам нужно написать программу, 
...
for(let i=friday;i<=31;i+=7){    
    alert(`Сегодня пятница ${i}-e число. Необходимо подготовить отчет.`);
}
//-------------------------------------------------------------------------------------------